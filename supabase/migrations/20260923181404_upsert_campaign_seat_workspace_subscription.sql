CREATE OR REPLACE FUNCTION public.provision_campaign_seat_stripe_request(target_request_id uuid)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
...
begin
  ...
  on conflict (workspace_id) do update set
    ...
    metadata = public.workspace_subscriptions.metadata || excluded.metadata,
    updated_at = now();
